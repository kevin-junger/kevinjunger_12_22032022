      ...
      <>
        { this.state.data &&
          <>
            ...
            <div className="nutrition__card">
              <div className="nutrition__icon nutrition__icon--proteins">
              ...
              <div>
                <h3>{this.state.data.proteinCount} g</h3>
                <em>Protéines</em>
              </div>
            </div>
            <div className="nutrition__card">
              <div className="nutrition__icon nutrition__icon--glucids">
              ...
              <div>
                <h3>{this.state.data.carbohydrateCount} g</h3>
                <em>Glucides</em>
              </div>
            </div>
            <div className="nutrition__card">
              <div className="nutrition__icon nutrition__icon--fats">
              ...
              <div>
                <h3>{this.state.data.lipidCount} g</h3>
                <em>Lipides</em>
              </div>
            </div>
          </>
